...
|===
  26+^|*RV32T对象描述符格式*
   ...
   1+^|P 1+^|BR 1+^|RC 1+^|FR 5+^|PageSize  18+^|Bound Address 
...
BR: Borrow，存在指针被借用的可能，需要额外的机制，检查时间内存安全。

RC: Reference Count，是否是智能指针
...
|===
  26+^|*RV64T对象描述符格式*
   ...
   1+^|P 1+^|BR 1+^|ST 1+^|FR 5+^|PageSize      3+^|Reserved  14+^|Address 
|===
