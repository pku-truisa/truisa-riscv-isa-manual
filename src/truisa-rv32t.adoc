...
* B-Radix表示Address所在内存对象是固定大小的内存块，块大小和对齐都是2的B-Radix幂次方。B-Radix小于等于25，大于25的值都按25处理。
...
|===
  26+^|*RV32T描述符旁视缓冲表项格式*
   ...
   1+^|L 1+^|G 1+^|0  1+^|X  1+^|0 1+^|R 1+^|0       19+^|Base Address
   1+^|0 5+^|S-Radix                     1+^|W       19+^|Bound Address
...
|===
  26+^|*RV64T描述符旁视缓冲表项格式*
   ...
   1+^|L 1+^|G 2+^|00    1+^|X  1+^|0 1+^|R 1+^|0 18+^|Base Address   
   1+^|0 6+^|S-Radix                        1+^|W 18+^|Bound Address
